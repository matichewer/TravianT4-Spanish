...
<h4 class="round">Los mejores atacantes</h4>
<table cellpadding="1" cellspacing="1" id="player_off" class="row_table_data">
	<thead>
		<tr><td></td><td>Jugador</td><td>Población</td><td>Aldeas</td><td>Puntos</td></tr>
		</thead><tbody>
<?php
if($_POST['rank'] > 0){
$myrank = $_POST['rank'];
...
$myrank = $ranking->getUserAttRank($uid);
}else{
$myrank = $ranking->getUserAttRank($session->uid);
}
if(!isset($_GET['page'])){
    if($myrank > 20){
...
$paginationDisplay .=  '<img alt="Página anterior" src="img/x.gif" class="previous disabled">';
$paginationDisplay .= $centerPages;
$paginationDisplay .=  '<a class="next" href="?tid=31&page=' . $nextPage . '"><img alt="Página siguiente" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="last" href="?tid=31&page=' . $lastPage . '"><img alt="Última página" src="img/x.gif"></a>';

}elseif ($page != "1" && $page != $lastPage){
$paginationDisplay .=  '<a class="first" href="?tid=31&page=1"><img alt="Primera página" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="previous" href="?tid=31&page=' . $previous . '"><img alt="Página anterior" src="img/x.gif"></a>';
$paginationDisplay .= $centerPages;
$paginationDisplay .=  '<a class="next" href="?tid=31&page=' . $nextPage . '"><img alt="Página siguiente" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="last" href="?tid=31&page=' . $lastPage . '"><img alt="Última página" src="img/x.gif"></a>';
...
$paginationDisplay .=  '<img alt="Última página" src="img/x.gif" class="last disabled">';
	...
	while($row = mysql_fetch_array($sql2)){ 
        ...
        echo "<td class=\"ap\">".number_format((int)$row['apall'], 0, ',', '.')."</td></tr>";
