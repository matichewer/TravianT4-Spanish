...
<h4 class="round">Alianzas más atacantes</h4>
...
$paginationDisplay .=  '<img alt="Página anterior" src="img/x.gif" class="previous disabled">';
$paginationDisplay .= $centerPages;
$paginationDisplay .=  '<a class="next" href="?tid=41&page=' . $nextPage . '"><img alt="Página siguiente" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="last" href="?tid=41&page=' . $lastPage . '"><img alt="Última página" src="img/x.gif"></a>';

}elseif ($page != "1" && $page != $lastPage){
$paginationDisplay .=  '<a class="first" href="?tid=41&page=1"><img alt="Primera página" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="previous" href="?tid=41&page=' . $previous . '"><img alt="Página anterior" src="img/x.gif"></a>';
$paginationDisplay .= $centerPages;
$paginationDisplay .=  '<a class="next" href="?tid=41&page=' . $nextPage . '"><img alt="Página siguiente" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="last" href="?tid=41&page=' . $lastPage . '"><img alt="Última página" src="img/x.gif"></a>';
