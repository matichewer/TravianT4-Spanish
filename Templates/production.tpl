...
<table id="production" cellpadding="1" cellspacing="1" style="width:100%;">
	...
	<tbody>
		...
		?>
		<tr>
			<td class="ico tooltip" title="<?php echo htmlspecialchars($tooltip, ENT_QUOTES, 'UTF-8'); ?>"><img class="<?php echo $resourceInfo['class']; ?>" src="img/x.gif" alt="<?php echo $resourceInfo['label']; ?>" /></td>
			<td class="res tooltip" title="<?php echo htmlspecialchars($tooltip, ENT_QUOTES, 'UTF-8'); ?>"><?php echo $resourceInfo['label']; ?>:</td>
