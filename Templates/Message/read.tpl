...
<button type="submit" value="Eliminar" name="delmsg" id="delmsg">
...
<div class="paper" >
	...
	<div class="paperContent">
		...
		<div id="sender">
			<div class="header label">Remitente</div>
		...
		<div id="time">
			<div class="header label">Fecha de envío</div>
	...
	<input type="hidden" name="t" value="1" />
                ...
                <div class="button-container"><div class="button-position"><div class="btl"><div class="btr"><div class="btc"></div></div></div><div class="bml"><div class="bmr"><div class="bmc"></div></div></div><div class="bbl"><div class="bbr"><div class="bbc"></div></div></div></div><div class="button-contents">Responder</div></div></button>
                </form>
		</div>
	</div>
</div>
