			...
			<div id="message_container" class="bbEditor">
				...
				<div id="message_toolbar" class="bbToolbar"><button type="button" value="bbBold" class="icon bbButton bbBold bbType{d} bbTag{b}"><img src="img/x.gif" class="bbBold" alt="bbBold"></button><button type="button" value="bbItalic" class="icon bbButton bbItalic bbType{d} bbTag{i}"><img src="img/x.gif" class="bbItalic" alt="bbItalic"></button><button type="button" value="bbUnderscore" class="icon bbButton bbUnderscore bbType{d} bbTag{u}"><img src="img/x.gif" class="bbUnderscore" alt="bbUnderscore"></button><button type="button" value="bbAlliance" class="icon bbButton bbAlliance bbType{d} bbTag{alliance0}"><img src="img/x.gif" class="bbAlliance" alt="bbAlliance"></button><button type="button" value="bbPlayer" class="icon bbButton bbPlayer bbType{d} bbTag{player0}"><img src="img/x.gif" class="bbPlayer" alt="bbPlayer"></button><button type="button" value="bbCoordinate" class="icon bbButton bbCoordinate bbType{d} bbTag{coor0}"><img src="img/x.gif" class="bbCoordinate" alt="bbCoordinate"></button><button type="button" value="bbReport" class="icon bbButton bbReport bbType{d} bbTag{report0}"><img src="img/x.gif" class="bbReport" alt="bbReport"></button><button type="button" value="bbResource" id="message_resourceButton" class="bbWin{resources} bbButton bbResource icon"><img src="img/x.gif" class="bbResource" alt="bbResource"></button><button type="button" value="bbSmilies" id="message_smilieButton" class="bbWin{smilies} bbButton bbSmilies icon"><img src="img/x.gif" class="bbSmilies" alt="bbSmilies"></button><button type="button" value="bbTroops" id="message_troopButton" class="bbWin{troops} bbButton bbTroops icon"><img src="img/x.gif" class="bbTroops" alt="bbTroops"></button><button type="button" value="bbPreview" id="message_previewButton" class="icon bbButton bbPreview"><img src="img/x.gif" class="bbPreview" alt="bbPreview"></button><div class="clear"></div>
					<div id="message_toolbarWindows" class="bbToolbarWindow">
						<div id="message_resources"><a href="#" class="bbType{o} bbTag{l}"><img src="img/x.gif" class="r1" alt="Madera"></a><a href="#" class="bbType{o} bbTag{cl}"><img src="img/x.gif" class="r2" alt="Barro"></a><a href="#" class="bbType{o} bbTag{c}"><img src="img/x.gif" class="r4" alt="Cereal"></a><a href="#" class="bbType{o} bbTag{i}"><img src="img/x.gif" class="r3" alt="Hierro"></a></div>
						...
						<div id="message_troops"><a href="#" class="bbType{o} bbTag{tid1}"><img class="unit u1" src="img/x.gif" alt="Legionario"></a><a href="#" class="bbType{o} bbTag{tid2}"><img class="unit u2" src="img/x.gif" alt="Pretoriano"></a><a href="#" class="bbType{o} bbTag{tid3}"><img class="unit u3" src="img/x.gif" alt="Imperano"></a><a href="#" class="bbType{o} bbTag{tid4}"><img class="unit u4" src="img/x.gif" alt="Equites Legati"></a><a href="#" class="bbType{o} bbTag{tid5}"><img class="unit u5" src="img/x.gif" alt="Equites Imperatoris"></a><a href="#" class="bbType{o} bbTag{tid6}"><img class="unit u6" src="img/x.gif" alt="Equites Caesaris"></a><a href="#" class="bbType{o} bbTag{tid7}"><img class="unit u7" src="img/x.gif" alt="Ariete"></a><a href="#" class="bbType{o} bbTag{tid8}"><img class="unit u8" src="img/x.gif" alt="Catapulta de fuego"></a><a href="#" class="bbType{o} bbTag{tid9}"><img class="unit u9" src="img/x.gif" alt="Senador"></a><a href="#" class="bbType{o} bbTag{tid10}"><img class="unit u10" src="img/x.gif" alt="Colono"></a><a href="#" class="bbType{o} bbTag{tid11}"><img class="unit u11" src="img/x.gif" alt="Luchador de porra"></a><a href="#" class="bbType{o} bbTag{tid12}"><img class="unit u12" src="img/x.gif" alt="Lancero"></a><a href="#" class="bbType{o} bbTag{tid13}"><img class="unit u13" src="img/x.gif" alt="Luchador de Hacha"></a><a href="#" class="bbType{o} bbTag{tid14}"><img class="unit u14" src="img/x.gif" alt="Emisario"></a><a href="#" class="bbType{o} bbTag{tid15}"><img class="unit u15" src="img/x.gif" alt="Paladín"></a><a href="#" class="bbType{o} bbTag{tid16}"><img class="unit u16" src="img/x.gif" alt="Jinete germano"></a><a href="#" class="bbType{o} bbTag{tid17}"><img class="unit u17" src="img/x.gif" alt="Ariete"></a><a href="#" class="bbType{o} bbTag{tid18}"><img class="unit u18" src="img/x.gif" alt="Catapulta"></a><a href="#" class="bbType{o} bbTag{tid19}"><img class="unit u19" src="img/x.gif" alt="Cabecilla"></a><a href="#" class="bbType{o} bbTag{tid20}"><img class="unit u20" src="img/x.gif" alt="Colono"></a><a href="#" class="bbType{o} bbTag{tid21}"><img class="unit u21" src="img/x.gif" alt="Falange"></a><a href="#" class="bbType{o} bbTag{tid22}"><img class="unit u22" src="img/x.gif" alt="Espadachín"></a><a href="#" class="bbType{o} bbTag{tid23}"><img class="unit u23" src="img/x.gif" alt="Batidor"></a><a href="#" class="bbType{o} bbTag{tid24}"><img class="unit u24" src="img/x.gif" alt="Rayo de Teutates"></a><a href="#" class="bbType{o} bbTag{tid25}"><img class="unit u25" src="img/x.gif" alt="Jinete Druida"></a><a href="#" class="bbType{o} bbTag{tid26}"><img class="unit u26" src="img/x.gif" alt="Jinete Eduo"></a><a href="#" class="bbType{o} bbTag{tid27}"><img class="unit u27" src="img/x.gif" alt="Ariete"></a><a href="#" class="bbType{o} bbTag{tid28}"><img class="unit u28" src="img/x.gif" alt="Catapulta"></a><a href="#" class="bbType{o} bbTag{tid29}"><img class="unit u29" src="img/x.gif" alt="Cacique"></a><a href="#" class="bbType{o} bbTag{tid30}"><img class="unit u30" src="img/x.gif" alt="Colono"></a><a href="#" class="bbType{o} bbTag{tid31}"><img class="unit u31" src="img/x.gif" alt="Rata"></a><a href="#" class="bbType{o} bbTag{tid32}"><img class="unit u32" src="img/x.gif" alt="Araña"></a><a href="#" class="bbType{o} bbTag{tid33}"><img class="unit u33" src="img/x.gif" alt="Serpiente"></a><a href="#" class="bbType{o} bbTag{tid34}"><img class="unit u34" src="img/x.gif" alt="Murciélago"></a><a href="#" class="bbType{o} bbTag{tid35}"><img class="unit u35" src="img/x.gif" alt="Jabalí"></a><a href="#" class="bbType{o} bbTag{tid36}"><img class="unit u36" src="img/x.gif" alt="Lobo"></a><a href="#" class="bbType{o} bbTag{tid37}"><img class="unit u37" src="img/x.gif" alt="Oso"></a><a href="#" class="bbType{o} bbTag{tid38}"><img class="unit u38" src="img/x.gif" alt="Cocodrilo"></a><a href="#" class="bbType{o} bbTag{tid39}"><img class="unit u39" src="img/x.gif" alt="Tigre"></a><a href="#" class="bbType{o} bbTag{tid40}"><img class="unit u40" src="img/x.gif" alt="Elefante"></a><a href="#" class="bbType{o} bbTag{tid41}"><img class="unit u41" src="img/x.gif" alt="Piquero"></a><a href="#" class="bbType{o} bbTag{tid42}"><img class="unit u42" src="img/x.gif" alt="Guerrero espinoso"></a><a href="#" class="bbType{o} bbTag{tid43}"><img class="unit u43" src="img/x.gif" alt="Defensor"></a><a href="#" class="bbType{o} bbTag{tid44}"><img class="unit u44" src="img/x.gif" alt="Pájaro de presa"></a><a href="#" class="bbType{o} bbTag{tid45}"><img class="unit u45" src="img/x.gif" alt="Hachero jinete"></a><a href="#" class="bbType{o} bbTag{tid46}"><img class="unit u46" src="img/x.gif" alt="Caballero natariano"></a><a href="#" class="bbType{o} bbTag{tid47}"><img class="unit u47" src="img/x.gif" alt="Elefante de guerra"></a><a href="#" class="bbType{o} bbTag{tid48}"><img class="unit u48" src="img/x.gif" alt="Ballesta"></a><a href="#" class="bbType{o} bbTag{tid49}"><img class="unit u49" src="img/x.gif" alt="Emperador natariano"></a><a href="#" class="bbType{o} bbTag{tid50}"><img class="unit u50" src="img/x.gif" alt="Colono"></a><a href="#" class="bbType{o} bbTag{hero}"><img class="unit uhero" src="img/x.gif" alt="Héroe"></a></div>
					</div>
				</div>
					</div>
				</div>
...
if(is_int($i/2)){ echo "<tr>"; } ?><td class="end"><a href="nachrichten.php?delfriend=<?php echo $i; ?>"><img class="del" src="img/x.gif" alt="eliminar" title="eliminar"></td>
  <td class="pla">
...
if(is_int($i/2)){ echo "<tr>"; } ?><td class="end"><a href="nachrichten.php?delfriend=<?php echo $i; ?>"><img class="del" src="img/x.gif" alt="eliminar" title="eliminar"></td>
  <td class="pla">
  <?php echo "<img src=\"../../".GP_LOCATE."img/a/clock-inactive.gif\" alt=\"esperando confirmación\" title=\"esperando confirmación\"><a href=\"nachrichten.php?t=1&id=".$user['friend'.$i]."\"> ".$database->getUserField($user['friend'.$i],"username",0)."</a>"; ?>
  </td>
		<?php
            echo "<td class=on></td>";
if(!is_int($i/2)){ echo "</tr>"; }else{ echo "<td></td>";}
