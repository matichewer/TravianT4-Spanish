    ...
    <div class="login">
        ...
        <table style="margin-top:10px" align="center" cellpadding="0" cellspacing="3" width="300" height="142">
            <tr>
                ...
                <img border="0" src="images/breadcrumb_separator_arrow_1_dot.png" width="10" height="5">Usuario :</td>
                <td height="19" width="371" colspan="2"><input name="name" value="<?php echo $_SESSION['username']; ?>" maxlength="15"></td>
            </tr>
            <tr>
                <td height="21" width="70">
                <img border="0" src="images/breadcrumb_separator_arrow_1_dot.png" width="10" height="5">Contraseña :</td>
                <td height="21" width="371" colspan="2"><input name="pw" type="password" value="" maxlength="20"></td>
            </tr>
            <tr>
                <td height="19" width="157">
                <img border="0" src="images/breadcrumb_separator_arrow_1_dot.png" width="10" height="5">Código de seguridad :</td>
            ...
            <tr>
                <td colspan="3">
                <p align="center"><input name="submit" type="submit" value=" Entrar " size="20" ></p>
                </td>
            </tr>
