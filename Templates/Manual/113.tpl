...
<tbody><tr>
	...
	<th>Velocidad</th>
	<td><b>6</b> casillas/hora</td>
</tr>
<tr>
	<th>Puede transportar</th>
	<td><b>50</b> recursos</td>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="duración" title="duración" /> 0:20:00</td>

</tr>
</tbody></table>

<img id="big_unit" class="big_u13" src="img/x.gif" alt="Luchador de Hacha" title="Luchador de Hacha" /><div id="t_desc">Esta es la unidad de infantería más fuerte de los germanos. Es fuerte tanto en ataque como en defensa, pero es más lento y más caro que otras unidades.</div><div id="prereqs"><b>Requisitos</b><br /><a href="manual.php?typ=4&amp;gid=22">Academia</a> Nivel 3, <a href="manual.php?typ=4&amp;gid=12">Herrería</a> Nivel 1</div><map id="nav" name="nav">
