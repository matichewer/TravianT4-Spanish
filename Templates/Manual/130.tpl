<h1><img class="unit u30" src="img/x.gif" alt="Colono" title="Colono" /> Colono <span class="tribe">(Galos)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="duración" title="duración" /> <?php echo isset($manualTrainingDuration) ? $manualTrainingDuration : '6:18:20'; ?></td>

</tr>
</tbody></table>

<img id="big_unit" class="big_u30" src="img/x.gif" alt="Colono" title="Colono" /><div id="t_desc">Los colonos son ciudadanos valientes y atrevidos que dejan la aldea tras un largo entrenamiento para fundar una nueva aldea en tu honor.
<br /><br />
Como el viaje y la fundación de la nueva aldea son muy difíciles, tres colonos deben viajar juntos. Necesitan una base de 750 unidades de cada recurso.</div><div id="prereqs"><b>Requisitos</b><br /><a href="manual.php?typ=4&amp;gid=26">Palacio</a> Nivel 10 o <a href="manual.php?typ=4&amp;gid=25">Residencia</a> Nivel 10</div><map id="nav" name="nav">
 <area href="manual.php?typ=1&amp;s=29" title="atrás" coords="0,0,45,18" shape="rect" alt="" />
