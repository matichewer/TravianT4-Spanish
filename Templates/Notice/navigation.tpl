...
<div class="footer">
	...
	<div style="float: right;">
		<button type="button" class="reportNavigationButton<?php if(!$noticeNeighbors['next']) { ?> disabled<?php } ?>" value="Mas antiguo"<?php if($noticeNeighbors['next']) { ?> onclick="window.location.href = 'berichte.php?id=<?php echo $noticeNeighbors['next'].$reportFilterQuery; ?>';"<?php } else { ?> disabled="disabled"<?php } ?>>
			<div class="button-container"><div class="button-position"><div class="btl"><div class="btr"><div class="btc"></div></div></div><div class="bml"><div class="bmr"><div class="bmc"></div></div></div><div class="bbl"><div class="bbr"><div class="bbc"></div></div></div></div><div class="button-contents">Más antiguo &raquo;</div></div>
		</button>
	</div>
	<div class="clear"></div>
</div>
