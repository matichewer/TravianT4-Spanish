<div class="footer">
	<div style="float: left;">
		<button type="button" value="Anterior"<?php if($noticeNeighbors['previous']) { ?> onclick="window.location.href = 'berichte.php?id=<?php echo $noticeNeighbors['previous']; ?>';"<?php } else { ?> class="disabled" disabled="disabled"<?php } ?>>
	...
	<div style="float: right;">
		<button type="button" value="Siguiente"<?php if($noticeNeighbors['next']) { ?> onclick="window.location.href = 'berichte.php?id=<?php echo $noticeNeighbors['next']; ?>';"<?php } else { ?> class="disabled" disabled="disabled"<?php } ?>>
