...
<div class="footer">
	...
	<div style="float: left;">
		<button type="button" class="reportNavigationButton<?php if(!$noticeNeighbors['previous']) { ?> disabled<?php } ?>" value="Anterior"<?php if($noticeNeighbors['previous']) { ?> onclick="window.location.href = 'berichte.php?id=<?php echo $noticeNeighbors['previous'].$reportFilterQuery; ?>';"<?php } else { ?> disabled="disabled"<?php } ?>>
	...
	<div style="float: right;">
		<button type="button" class="reportNavigationButton<?php if(!$noticeNeighbors['next']) { ?> disabled<?php } ?>" value="Siguiente"<?php if($noticeNeighbors['next']) { ?> onclick="window.location.href = 'berichte.php?id=<?php echo $noticeNeighbors['next'].$reportFilterQuery; ?>';"<?php } else { ?> disabled="disabled"<?php } ?>>
