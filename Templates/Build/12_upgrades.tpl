...
<div class=\"showCosts\">
<span class=\"resources r1 little_res\"><img class=\"r1\" src=\"img/x.gif\" alt=\"Madera\">".${'ab'.$i}[$abdata['b'.$j]+1]['wood']."</span>
<span class=\"resources r2 little_res\"><img class=\"r2\" src=\"img/x.gif\" alt=\"Barro\">".${'ab'.$i}[$abdata['b'.$j]+1]['clay']."</span>
<span class=\"resources r3\"><img class=\"r3\" src=\"img/x.gif\" alt=\"Hierro\">".${'ab'.$i}[$abdata['b'.$j]+1]['iron']."</span>
<span class=\"resources r4\"><img class=\"r4\" src=\"img/x.gif\" alt=\"Cereal\">".${'ab'.$i}[$abdata['b'.$j]+1]['crop']."</span>
<div class=\"clear\"></div>
...
</div><div class=\"button-contents\">mejorar</div></div></button>
                    </span></div>";
				}
echo "</div>
<div class=\"clear\"></div>
