<h1 class="titleInHeader">Gran cuartel <span class="level">Nivel <?php echo $village->resarray['f'.$id]; ?></span></h1>
...
<input type="hidden" name="k" value="<?php echo $session->mchecker; ?>" />
    ...
    <?php
        ...
        echo "<b>El entrenamiento puede comenzar cuando el gran cuartel esté terminado.</b><br>\n";
    }
