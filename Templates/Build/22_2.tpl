...
if($fail > 0) { 
    ...
    <div id=\"researchFuture\" class=\"researches hide \">";
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">Akadémia</a><span class=\"level\"> Nivel 10</span>, <a href=\"#\">Taller</a><span class=\"level\"> Nivel 1</span></div></div><div class=\"clear\"></div></div><hr>";
     }
