...
<div class="build_desc">
	...
	En los niveles 10, 15 y 20 de la mansión del héroe puedes ocupar un valle abandonado (oasis) con tu héroe, hasta tres oasis por aldea. Según el oasis anexado, obtendrás un aumento de producción de un recurso (o incluso de dos, en algunos oasis).</div>
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <?php echo $building->requirementsHtml(37); ?>
    </div>
	<div class="clear"></div>
</div>
