...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(24,4);" class="build_logo">
		<img class="building big white g24" src="img/x.gif" alt="Ayuntamiento">


	</a>
	En el ayuntamiento puedes celebrar fiestas pomposas. Estas celebraciones aumentan tus puntos de cultura. Mejorar el ayuntamiento a un nivel mayor reduce la duración de la celebración.</div>
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(22,4, 'gid');">Academia</a> <span>Nivel 10</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');">Edificio principal</a> <span>Nivel 3</span></span>
    </div>
	<div class="clear"></div>
</div>
