...
<div class="build_desc">
	...
	En el taller se pueden construir máquinas de asedio como catapultas y arietes. Cuanto mayor sea su nivel, más rápido se producen las unidades.</div>
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(22,4, 'gid');">Academia</a> <span>Nivel 10</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');">Edificio principal</a> <span>Nivel 5</span></span>
    </div>
	<div class="clear"></div>
</div>
