...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(9,4);" class="build_logo">
		<img class="building big white g9" src="img/x.gif" alt="Panadería">
	</a>
	Aquí se usa la harina de tu molino para hornear pan. Combinada con el molino, se puede lograr un aumento de la producción de cereal de hasta el 50%.</div>
