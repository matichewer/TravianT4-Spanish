...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(30,4);" class="build_logo">
		<img class="building big white g30" src="img/x.gif" alt="Gran establo">


	</a>
	El gran establo te permite tener un segundo establo en la misma aldea, pero las tropas cuestan el triple.</div>
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(21,4, 'gid');">Establo</a> <span>Nivel 20</span></span>
    </div>
	<div class="clear"></div>
</div>
