<h1 class="titleInHeader"><?php echo B1; ?> <span class="level">Nivel <?php echo $village->resarray['f'.$id]; ?></span></h1>
...
<table cellpadding="1" cellspacing="1" id="build_value">
	...
	<tr>
		...
		<td><b><?php echo $bid1[$upgradeLevel]['prod']* SPEED; ?></b> <?php echo PER_HR; ?></td>
	</tr>
    <?php } ?>
</table>
<?php 
