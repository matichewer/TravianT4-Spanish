...
<table id="member"> 
  <thead>
    ...
    <tr>
        <td>Remaining Silver</td>
        <td><?php
		if($user['silver'] == 0){ ?>
		This user has no silver! (<img src='../img/admin/silver.gif' class='silver' alt='silver' title='This user has: <?php echo $user['silver']; ?> silver'/> <?php echo $user['silver']; ?>) <?php if($_SESSION['access'] == ADMIN){ ?><a href='admin.php?p=player&uid=<?php echo $id; ?>&s'>Give silver <?php } ?></a>
		<?php }
		else if($user['silver'] > 0){ ?>
		<img src='../img/admin/silver.gif' class='silver' alt='silver' title='This user has: <?php echo $user['silver']; ?> silver'/> <?php echo $user['silver']; ?>  <?php if($_SESSION['access'] == ADMIN){ ?><a href='admin.php?p=player&uid=<?php echo $id; ?>&s'><img src='../img/admin/edit.gif' title='Give Silver'><?php } ?></a></td>
		<?php }
		?>
    </tr>
	<?php 	
	...
	if($_GET['s'] == 'ok'){
		...
		<tr>
		<td>Insert number and press 'enter'</td>
		<td><input class="give_gold" name="silver" value="0"> <a href="admin.php?p=player&uid=<?php echo $id; ?>"><img src="../img/admin/del.gif" title="Cancel"></a></td>
		</tr></form>
		<?php } } }?>
	<tr><td></td><td></td></tr>
	  <tr>
...
<tr><td></td><td></td></tr>
  ...
  <tr>
        ...
        <td><?php echo $user['cp'];?> <?php if($_SESSION['access'] == ADMIN){ ?><a href='admin.php?p=player&uid=<?php echo $id; ?>&cp'><img src='../img/admin/edit.gif' title='Give CP'><?php } ?>
</tr>
