<div align="center">
	<ul class="tabs">
		<li><a id="a_title_1" onclick="SetCurrent(1);" class="current" href="#">Administrar noticias</a></li>
	</ul>
</div><Br>
<div id="div_1">
...
<table width="350" border="1" align="center" class="tbl" id="tabs_2_content_in">
	...
	<tr>
        ...
        <td bgcolor="#f3f7f8" height="26" align="center"><?php if(NEWSBOX1){ echo "<div id='nsts1'><font color='green'>Activo</font></div>"; }else{ echo "<div id='nsts1'><font color='red'>Inactivo</font></div>"; } ?></td>
    ...
    <tr>
        ...
        <td bgcolor="#f3f7f8" height="26" align="center"><?php if(NEWSBOX2){ echo "<div id='nsts2'><font color='green'>Activo</font></div>"; }else{ echo "<div id='nsts2'><font color='red'>Inactivo</font></div>"; } ?></td>
        <td height="26" align="center" bgcolor="#f3f7f8"> Sí &nbsp; No
          <p>
    ...
    <tr>
        ...
        <td bgcolor="#f3f7f8" height="26" align="center"><?php if(NEWSBOX3){ echo "<div id='nsts3'><font color='green'>Activo</font></div>"; }else{ echo "<div id='nsts3'><font color='red'>Inactivo</font></div>"; } ?></td>
        <td height="26" align="center" bgcolor="#f3f7f8"> Sí &nbsp; No
          <p>
