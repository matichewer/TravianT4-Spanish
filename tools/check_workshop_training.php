...
$village->cropProduction = $u7['pop'] - 1;
workshopAssert($baseTechnology->maxUnit(7) === 0,'Training maximum must be zero without enough free crop.');
$village->cropProduction = $u7['pop'] * 2;
$cropLimitedMaximum = $baseTechnology->maxUnit(7);
workshopAssert((int)$cropLimitedMaximum === 2,'Training maximum must include the available free-crop limit (got '.$cropLimitedMaximum.').');
