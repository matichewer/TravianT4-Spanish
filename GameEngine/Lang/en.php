...
define("EMAIL_EMPTY", "Please enter your email address in the format yourname@mail.com.");
define("EMAIL_SHORT", "We are sorry, but this email address seems to be too short. It should contain at least 5 characters.");
define("EMAIL_INVALID","(Invalid email address)");
define("EMAIL_TAKEN","(Email is already in use)");
define("EMAIL_NOTEXIST", "Email address could not be found");
...
define("NAME_NO_EXIST", "Player was not found");
...
define("B1_DESC","The Woodcutter cuts down trees in order to produce Wood. The further you extend the bid1 the more Wood is produced by him.");
...
define("Q1_DESC","There are four green forests around your village. Construct a woodcutter on one of them. Wood is an important resource for our new settlement.");
define("Q1_ORDER","Order:<\/p>Construct a woodcutter.");
define("Q1_RESP","Yes, that way you gain more Wood.I helped a bit and completed the order instantly.");
