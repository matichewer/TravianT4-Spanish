...
define("REPORT_ATTACK_TYPE","Tipo de ataque");
define("REPORT_ATTACK_TYPE_NORMAL","Ataque");
define("REPORT_ATTACK_TYPE_SCOUT","Espionaje");
...
define("REPORT_SPY_DETECTED","detectado");
define("REPORT_SPY_UNDETECTED","no detectado");
...
define("WARSIM_HEROPOWER","Bonificación ofensiva del héroe (%)");
define("WARSIM_KATA","Nivel del edificio objetivo");
define("WARSIM_NORMAL","Normal");
define("WARSIM_PALACE","Residencia/Palacio");
