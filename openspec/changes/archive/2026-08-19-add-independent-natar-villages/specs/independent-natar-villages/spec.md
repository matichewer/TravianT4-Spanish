...
Defines the living NPC village: a Natar village that grows, produces, trains and can be farmed or razed, as distinct from the static garrisons of the Wonder villages and the Natar capital.
