...
The system SHALL calculate founding and conquest eligibility using owned villages plus all unprocessed settlements reserved by the account, regardless of their source village.
...
- **WHEN** the account's culture points allow all owned and pending villages plus one more
