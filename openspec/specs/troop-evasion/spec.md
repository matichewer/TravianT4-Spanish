# troop-evasion Specification

## Purpose

Defines when Gold Club capital troop evasion triggers, which troops it moves, how it interacts with ordinary returns and the hero's independent hiding preference, and how players configure it securely.
